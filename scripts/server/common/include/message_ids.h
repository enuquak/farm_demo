...
inline constexpr uint32_t MSG_ID_ATTACK_REQ                       = 5001;  // 攻击请求
inline constexpr uint32_t MSG_ID_ATTACK_NOTIFY                    = 5002;  // 攻击结果通知
inline constexpr uint32_t MSG_ID_MONSTER_SPAWN_NOTIFY             = 5010;  // 怪物刷新通知
inline constexpr uint32_t MSG_ID_MONSTER_DEATH_NOTIFY             = 5011;  // 怪物死亡通知
inline constexpr uint32_t MSG_ID_MONSTER_MOVE_NOTIFY              = 5012;  // 怪物移动通知
inline constexpr uint32_t MSG_ID_MONSTER_ATTACK_NOTIFY            = 5013;  // 怪物攻击通知
inline constexpr uint32_t MSG_ID_PLAYER_HP_UPDATE                 = 5020;  // 玩家HP更新
inline constexpr uint32_t MSG_ID_PLAYER_DEATH_NOTIFY              = 5021;  // 玩家死亡通知
inline constexpr uint32_t MSG_ID_PLAYER_RESPAWN                   = 5022;  // 玩家复活
inline constexpr uint32_t MSG_ID_COMBAT_EXP_UPDATE                = 5030;  // 战斗经验更新
inline constexpr uint32_t MSG_ID_COMBAT_LEVEL_UP                  = 5031;  // 战斗升级
...
inline constexpr uint32_t MSG_ID_TEAM_CREATE_REQ                  = 7001;  // 创建队伍请求
inline constexpr uint32_t MSG_ID_TEAM_CREATE_RESP                 = 7002;  // 创建队伍响应
inline constexpr uint32_t MSG_ID_TEAM_DISBAND_REQ                 = 7003;  // 解散队伍请求
inline constexpr uint32_t MSG_ID_TEAM_DISBAND_RESP                = 7004;  // 解散队伍响应
inline constexpr uint32_t MSG_ID_TEAM_INVITE_REQ                  = 7005;  // 邀请玩家组队
inline constexpr uint32_t MSG_ID_TEAM_INVITE_RESP                 = 7006;  // 邀请结果
inline constexpr uint32_t MSG_ID_TEAM_INVITE_NOTIFY               = 7007;  // 收到组队邀请通知
inline constexpr uint32_t MSG_ID_TEAM_ACCEPT_REQ                  = 7008;  // 接受组队邀请
inline constexpr uint32_t MSG_ID_TEAM_ACCEPT_RESP                 = 7009;  // 接受邀请结果
inline constexpr uint32_t MSG_ID_TEAM_REJECT_REQ                  = 7010;  // 拒绝组队邀请
inline constexpr uint32_t MSG_ID_TEAM_REJECT_RESP                 = 7011;  // 拒绝邀请结果
inline constexpr uint32_t MSG_ID_TEAM_LEAVE_REQ                   = 7012;  // 离开队伍
inline constexpr uint32_t MSG_ID_TEAM_LEAVE_RESP                  = 7013;  // 离开队伍结果
inline constexpr uint32_t MSG_ID_TEAM_KICK_REQ                    = 7014;  // 踢出队伍成员
inline constexpr uint32_t MSG_ID_TEAM_KICK_RESP                   = 7015;  // 踢出结果
inline constexpr uint32_t MSG_ID_TEAM_INFO_REQ                    = 7016;  // 查询队伍信息
inline constexpr uint32_t MSG_ID_TEAM_INFO_RESP                   = 7017;  // 队伍信息响应
inline constexpr uint32_t MSG_ID_TEAM_MEMBER_UPDATE               = 7018;  // 队伍成员变更通知
inline constexpr uint32_t MSG_ID_TEAM_LEADER_CHANGE               = 7019;  // 队长变更通知
inline constexpr uint32_t MSG_ID_TEAM_STATUS_UPDATE               = 7020;  // 队伍状态变更通知
